describe("cart test", () => {
    ...
    it('should add the first product once from the home to the cart and added again from the home', () => {
        let name
        cy.get(':nth-child(1) > a > .product-details > #product-name').then($name => {
            name = $name.text()
            // cy.wait(1000);
            ...
            cy.get('[data-cy=product-quantity]').contains(1).should('exist')
            // cy.wait(1000);
            cy.get('[data-cy=go-to-home]').click();
            // cy.wait(1000);
            cy.get('[data-cy=plus-one]').first().click();
            // cy.wait(1000);
            cy.get('[data-cy=counter]').first().contains(1)
            ...
            cy.get('[data-cy=cart-items-list]').contains(name).should('exist')
            // cy.wait(1000);
            cy.get('[data-cy=product-quantity]').contains(2).should('exist')
            // cy.wait(1000);
        });
    });

    it('should add the first product once from the home to the cart and edit the quantity to two', () => {
        let name
        cy.get(':nth-child(1) > a > .product-details > #product-name').then($name => {
            name = $name.text()
            // cy.wait(1000);
            ...
            // cy.wait(1000);
            cy.get('[data-cy=counter]').first().contains(2)
        });
    });

    it('should add the first product once from the home to the cart and not edit the quantity to zero', () => {
        let name
        cy.get(':nth-child(1) > a > .product-details > #product-name').then($name => {
            name = $name.text()
            // cy.wait(1000);
            ...
            cy.get('[data-cy=product-quantity]').contains(1).should('exist')
            // cy.wait(1000);
            cy.get('[data-cy=minus-one]').click();
            // cy.wait(1000);
            cy.get('[data-cy=update-product]').click();
            // cy.wait(1000);
            cy.get('[data-cy=product-quantity]').contains(1).should('exist')
